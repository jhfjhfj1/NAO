...
def model_fn(features, labels, mode, params):
  if mode == tf.estimator.ModeKeys.TRAIN:
    ...
    model1 = decoder.DecoderModel(None, encoder_state, targets_1_inputs, targets_1, params, mode, 'Decoder_1')
    model2 = decoder.DecoderModel(None, encoder_state, targets_2_inputs, targets_2, params, mode, 'Decoder_2')
    loss1 = model1.loss
    loss2 = model2.loss
    ...
    encoder_state = tf.contrib.rnn.LSTMStateTuple(encoder_state, encoder_state)
    encoder_state = (encoder_state,) * params['decoder_num_layers']
    model1 = decoder.DecoderModel(None, encoder_state, targets_inputs, targets, params, mode, 'Decoder_1')
    model2 = decoder.DecoderModel(None, encoder_state, targets_inputs, targets, params, mode, 'Decoder_2')
    res1 = model1.decode()
    res2 = model2.decode()
